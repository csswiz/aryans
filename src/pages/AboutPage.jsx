  ...
  return (
    <div className="py-12 sm:py-16 animate-fadeIn">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {/* 1. ABOUT US Core Statements */}
        <div className="space-y-6">
          <div className="bg-[#FAF9F6] p-8 sm:p-10 rounded-3xl border border-stone-200/90 shadow-sm relative overflow-hidden">
          ...
          <div className="bg-royal-950 text-white p-8 sm:p-10 rounded-3xl border-2 border-gold-500/40 shadow-xl relative overflow-hidden">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg sm:text-xl text-stone-100 leading-relaxed font-light">
        ...
        <div className="pt-6 space-y-6">
          ...
          <div className="space-y-5 text-base sm:text-lg text-stone-700 leading-relaxed">
            <div className="p-6 sm:p-8 bg-ivory-100/80 rounded-2xl border border-stone-200">
              <p>
                The Aryans’ School was established formally in the year <strong className="text-royal-900 font-bold">2011</strong>. The foundation of this institution lies in the idea of <strong className="text-stone-900 font-semibold">“Giving back to the society”</strong> and <strong className="text-royal-900 font-semibold">“Seva Parmodharma”</strong> (Service is the highest form of dharma).
              </p>
            </div>
            ...
            <p>
              The school also recognises the rich cultural heritage of our beloved country and has its values deep rooted in the Indian culture. Be it the ideals of <strong className="text-stone-900 font-semibold">“Vasudeva Kutumbkam”</strong> (the entire world is one family) or <strong className="text-stone-900 font-semibold">“Aa no bhadra kratvo yantu vishrwat”</strong> (let noble thoughts come from all directions), the institution aims to spread the true Indian culture of acceptance and tolerance.
            </p>
            ...
            <div className="my-10 bg-gradient-to-r from-royal-950 via-royal-900 to-royal-950 text-white p-8 sm:p-12 rounded-3xl border-2 border-gold-400 shadow-2xl relative overflow-hidden">
              ...
              <div className="text-center space-y-5 max-w-3xl mx-auto">
                <p className="font-serif italic text-xl sm:text-2xl text-gold-300 tracking-wide leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
          ...
          {/* Mission Card */}
          <div className="bg-[#FAF9F6] p-8 sm:p-10 rounded-3xl border-2 border-royal-800/30 shadow-md flex flex-col justify-between space-y-5">
            ...
            <div className="w-12 h-1 bg-royal-800 rounded-full"></div>
          </div>

          {/* Vision Card */}
          <div className="bg-[#FAF9F6] p-8 sm:p-10 rounded-3xl border-2 border-gold-500/50 shadow-md flex flex-col justify-between space-y-5">
            <div className="space-y-3">
        ...
        <div className="pt-8 bg-gradient-to-r from-royal-900 to-royal-950 text-white p-8 sm:p-10 rounded-3xl border border-gold-500/30 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left shadow-xl">
          <div>

...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/academics/academic-1.jpg`, text: 'Smart Classrooms' },
      { image: `/academics/academic-2.jpg`, text: 'Play-Way Learning' },
      { image: `/academics/academic-3.jpg`, text: 'Science Laboratories' },
      { image: `/academics/academic-4.jpg`, text: 'Faculty Mentorship' },
      { image: `/academics/academic-5.jpg`, text: 'Scholarly Library' },
      { image: `/academics/academic-6.jpg`, text: 'Foundational Wing' },
      { image: `/academics/academic-7.jpg`, text: 'Campus Life' },
      { image: `/academics/academic-8.png`, text: 'Teacher Workshops' }
    ];
